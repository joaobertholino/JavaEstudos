...
//      O return em métodos void age como um break, impedindo a execução do resto do codigo caso caia no bloco if
      return;
    }
...
//    Definindo valores padrões para os parametros do método
    x = 99;
    y = 33;
  ...
  //  Método que soma numeros de um array passado como argumento
  ...
  public int sumVarArgs(int valueOne, int valueTwo, int... numbers) {
