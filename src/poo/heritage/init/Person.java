...
public class Person {
	static {
		System.out.println("Dentro do bloco de inicialização estático de Person!");
	}
	...
	{
		System.out.println("Dentro do bloco de inicialização não estático 1 de Person!");
	}

	{
		System.out.println("Dentro do bloco de inicialização não estático 2 de Person!");
	}
