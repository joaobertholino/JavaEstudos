...
/**
 * Uma interface em Java é um contrato que define um conjunto de métodos abstratos que uma classe deve implementar.
 ...
 * <p>
 * As interfaces também podem conter constantes (variáveis finais) e métodos estáticos. Uma classe pode implementar
